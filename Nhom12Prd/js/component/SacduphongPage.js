...
function SacduphongPage({ sacduphong, sortingType }) {
    return html`
        ${Header()}
        ${NavBar('sacduphong')}
        ${HeaderPanel()}
        ...
        <main>
            <section class="container-fluid bg-light d-flex justify-content-around p-5">
                <h2 class=""><strong>Sạc dự phòng</strong></h2> 
                ...
                <div class="container">
                    <div class="row g-md-5">
                        ${sortingType === 'ascending' ? 
                            sacduphong.slice(0).reverse().map((sacdp, index) => html`
                                <div class="product__list__item col-md-3 mb-2">
                                    <div class="product__card card shadow-sm">
                                        ...
                                        <div class="product__img__container">
                                            <img src=${sacdp.img} alt="" class="bd-placeholder-img card-img-top p-3">
                                        </div>

                                        <div class="product__body card-body">
                                            <a href="#" class="product__name card-text text-decoration-none">${sacdp.name}</a>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="btn-group">
                                                    <p class="product__actualprice border border-danger text-sm-danger rounded p-1">${sacdp.priceTags.actualPrice}đ</p>
                                                    <p class="product__initprice border border-secondary text-sm-muted rounded p-1 text-decoration-line-through">${sacdp.priceTags.initPrice}đ</p>
                                                </div>
                                                <button 
                                                    class="product__cart btn btn-sm btn-outline-secondary mb-lg-3"
                                                    onclick="dispatch('increaseCart', 'sacduphong', ${index}); showSuccessToast();"
                                                >
                            ...
                            `)
                            :
                            sacduphong.map((sacdp, index) => html`
                                <div class="product__list__item col-md-3 mb-2">
                                    <div class="product__card card shadow-sm">
                                        <p class="product__discount"></p>
                                        <div class="product__img__container">
...
export default connect()(SacduphongPage);
